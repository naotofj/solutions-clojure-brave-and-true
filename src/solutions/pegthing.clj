...
;; row-num works cuz tri seq has the highest value of each
;; row, meaning that if take-while will stop when the value of
;; the tri element is bigger than pos. E.g. pos = 5 will stop
;; at when tri "is" 6. When that happens, take-while returns 
;; the first two rows (1 and 3), meaning that 5 is after
;; those (explaining why we should use count, then inc)
